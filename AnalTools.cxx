...
Int_t AnalTools::Select_scriptQT1(Int_t set,FilesSet* P_Files,char* hntName)
{
  ...
  if(P_Files==0)
   ...
   p_out->Branch("br_RPE_QTN",&(QRPI.NE),"RPE_QTN/S");
   p_out->Branch("br_RPW_QTN",&(QRPI.NW),"RPW_QTN/S");
   p_out->Branch("br_RPE_Idx",(QRPI.RPE_Idx),"RPE_Idx[RPE_QTN]/S");
   p_out->Branch("br_RPW_Idx",(QRPI.RPW_Idx),"RPW_Idx[RPW_QTN]/S");
...
Int_t AnalTools::readq1(char* filelist,Int_t set,FilesSet* p_files)
{
  ...
  */
  ...
  //QTRP branch
  TwoTr.Branch("RPE_QTN",&(qtrpinfo.NE),"RPE_QTN/S");
  TwoTr.Branch("RPW_QTN",&(qtrpinfo.NW),"RPW_QTN/S");
  TwoTr.Branch("RPE_Idx",(qtrpinfo.RPE_Idx),"RPE_Idx[RPE_QTN]/S");
  TwoTr.Branch("RPW_Idx",(qtrpinfo.RPW_Idx),"RPW_Idx[RPW_QTN]/S");
